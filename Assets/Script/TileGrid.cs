...
public class TileGrid
{
    ...
    protected void DoMatchChecking()
    {
        int gridSize = m_grid.Length;
        for( int i = 0; i < gridSize; ++i )
        {
    ...
    protected void DoUnmarkAllTiles()
    {
        int gridSize = m_grid.Length;
        for( int i = 0; i < gridSize; ++i )
        {
    ...
    protected void DoTileMovements()
    {
    ...
    protected bool IsMatchingAnyAdjacentTiles( int x, int y )
    {
    ...
    protected bool IsMatchingAnyAdjacentTiles( int index )
    {
        if( index < 0 || index > m_grid.Length )
        {
            // out of bounds
